...
const Registration = ({ handleMenu }) => {
  ...
  const [fathersid, setFathersid] = useState('');
  const [nationality, setNationality] = useState('0');
  const [fathersnationality, setFathersnationality] = useState('0');
  const [mothersfirstname, setMothersfirstname] = useState('');
  const [motherslastname, setMotherslastname] = useState('');
  const [mothersnationality, setMothersnationality] = useState('0');
  ...
  function saveregistration() {
    ...
    data['gender'] = gender;
    data['fathersfirstname'] = fathersfirstname;
    data['fatherslastname'] = fatherslastname;
    data['fathersid'] = fathersid;
    data['nationality'] = nationality;
    data['fathersnationality'] = fathersnationality;
    data['mothersfirstname'] = mothersfirstname;
    data['motherslastname'] = motherslastname;
    data['mothersnationality'] = mothersnationality;
    data['mothersid'] = mothersid;
    data['guestDetails'] = guestForms;
    data['ranks'] = ranks;

    if (!firstname || !lastname || !candidateid || gender === '' || !fathersfirstname || !fatherslastname || !fathersid || !nationality || !fathersnationality || !mothersfirstname || !motherslastname || !mothersnationality || !mothersid) {
      setLoader(false)
      handleOpen()
      return false;
    } else {
  ...
  console.log("guestForms",guestForms?.length)
      ...
      <div className='register-bg'>
            ...
            <ul className='inputlisttop'>
              ...
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield inputwrpsingle'><input value={candidateid} onChange={e => setCandidateid(e.target.value)} placeholder='Enter ID xxxx xxxx xxxx xxxx' /></div>
                  </div>
                </div>
              </li>
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield inputwrpsingle'>
                      <select onChange={e => setRanks(e.target.value)}>
                        <option value="0">Select Rank</option>
                        <option value="1">None</option>
                        <option value="2">Rank 15</option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='custom-radio'>
                    <input type='radio' name="gender" onChange={() => setGender(1)} />
                    <label>Male</label>
                    <input className='femalinput' onChange={() => setGender(0)} type='radio' name="gender" />
                    <label>Female</label>
                  </div>
                </div>
              </li>
            ...
            <ul className='inputlisttop'>
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield'><input value={fathersfirstname} onChange={e => setFathersfirstname(e.target.value)} placeholder='Enter first name' /></div>
                    <div className='inputfield'><input value={fatherslastname} onChange={e => setFatherslastname(e.target.value)} placeholder='Enter last name' /></div>
                  </div>
                </div>
              </li>
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield inputwrpsingle'><input value={fathersid} onChange={e => setFathersid(e.target.value)} placeholder='Enter ID xxxx xxxx xxxx xxxx' /></div>
                  </div>
                </div>
              </li>
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield inputwrpsingle'>
                      <select value={fathersnationality} onChange={e => setFathersnationality(e.target.value)}>
                        <option value="0">Select nationality</option>
                        <option value="AF">Afghanistan</option>
                        <option value="AX">Åland Islands</option>
                        <option value="AL">Albania</option>
              ...
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield'><input value={mothersfirstname} onChange={e => setMothersfirstname(e.target.value)} placeholder='Enter first name' /></div>
                    <div className='inputfield'><input value={motherslastname} onChange={e => setMotherslastname(e.target.value)} placeholder='Enter last name' /></div>
                  </div>
                </div>
              </li>
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield inputwrpsingle'><input value={mothersid} onChange={e => setMothersid(e.target.value)} placeholder='Enter ID xxxx xxxx xxxx xxxx' /></div>
                  </div>
                </div>
              </li>
              <li>
                <div className='listlablewrp'>
                  ...
                  <div className='inputwrptop'>
                    <div className='inputfield inputwrpsingle'>
                      <select onChange={e => setMothersnationality(e.target.value)}>
                        <option value="0">Select nationality</option>
                        <option value="AF">Afghanistan</option>
                        <option value="AX">Åland Islands</option>
                        <option value="AL">Albania</option>
        ...
        <button className='addbtns' onClick={handleAddGuest} disabled = { guestForms?.length === 2 }>Add Guest {guestForms?.length === 0}</button>
          ...
          <div className='submit-btn'>
            <button onClick={saveregistration}>Submit
              {
